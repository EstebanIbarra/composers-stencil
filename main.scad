...
format = "TravelersNotebook"; // [A2, A3, A4, A5, PocketA5, Letter, Legal, Tabloid, TravelersNotebook, Passport, MoleskineL, MoleskineXL, MoleskineP]
...
/* [Symbols] */
// --- Enable rests ---
// Enables all rest symbols in the symbol registry.
enable_rests = true;

// --- Enable clefs ---
// Enables all clef symbols in the symbol registry (currently only behind bridge clef).
enable_clefs = true;
...
font_size = 3.5; // [3.0:0.5:10.0


/* [Rulers] */

// --- Enable top ruler ---
// Engraved ruler along the top edge of the stencil.
enable_top_ruler = false;

// --- Enable right ruler ---
// Engraved ruler along the right edge of the stencil.
enable_right_ruler = false;
...
// --- Enable left ruler ---
// Engraved ruler along the left edge of the stencil.
enable_left_ruler = true;
...
margin_ruler = margin + font_size / 2;
...
echo(
  str(
    ...
    "       - Clefs: ", enable_clefs ? "Enabled" : "Disabled", "\n",
    "     Engraving:\n",
    ...
    "       - Left ruler: ", enable_left_ruler ? "Enabled" : "Disabled", "\n",
